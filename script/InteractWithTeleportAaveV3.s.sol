...
contract InteractWithTeleportAaveV3 is Script {
    function run() external {
        address teleportAaveV3Address = 0xA54611ABc0c97126e5c8616c0FAd99787c1e3FC7; // update at each deployment
        address prepareTeleportAaveV3Address = 0x6465551aD922e92b88C0A1F5165364DF5B65FAfE; // update at each deployment
